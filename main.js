...
function createMainWindow() {
  ...
  mainWindow = new BrowserWindow({
    width: width,
    height: height,
    icon: path.join(__dirname, 'assets/icons/cloud.png'), // Uncomment if you have an icon
    resizable: isDev,
    webPreferences: {
...
function createAboutWindow() {
  ...
  aboutWindow = new BrowserWindow({
    ...
    icon: path.join(__dirname, 'images/Bob.ico'),
    useContentSize: true,
    menu: null, // Disable the menu for the About window
  });
...
function openNoteApp() {
  ...
  noteAppWindow = new BrowserWindow({
    ...
    icon: path.join(__dirname,  'images/Bob.ico'),
    useContentSize: true,
    menu: null, // Disable the menu for the Notes window
  });
